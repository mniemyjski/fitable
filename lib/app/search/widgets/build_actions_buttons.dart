...
List<Widget> buildActionButtons(BuildContext context, bool mobilePlatform, ETypeFavoriteScreen searchType) {
  return [
    IconButton(
    ...
    if (mobilePlatform && (searchType == ETypeFavoriteScreen.onlyProducts || searchType == ETypeFavoriteScreen.allFoods))
